...
> {
  ...
  constructor(
    @inject('datasources.veterinaria') dataSource: VeterinariaDataSource, @repository.getter('PersonaRepository') protected personaRepositoryGetter: Getter<PersonaRepository>,
  ) {
